...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/gflex-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10961&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/gflex-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `gflex` can be installed with:

```
conda install gflex
```

It is possible to list all of the versions of `gflex` available on your platform with:
